...
public static class SPFacebookAnalytics  {
	...
	public static void AddedPaymentInfo(bool IsPaymentInfoAvaliable) {
		Dictionary<string, object> EventParams = new Dictionary<string, object>();
		
		int val = 0;
		if (IsPaymentInfoAvaliable) {
			val = 1;
		}
	...
	public static void InitiatedCheckout(float price, int itemsCount, string ContentType, string ContentId, bool IsPaymentInfoAvaliable, string Currency = "USD") {
		Dictionary<string, object> EventParams = new Dictionary<string, object>();
