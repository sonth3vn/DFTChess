...
//        public Action OnSelect; //action to be called when this item is selected
		public delegate void SelectCell(string id, int value); //hack by sonth
		public SelectCell OnSelect = null;
        ...
        public DropDownListItem(string caption = "", string inId = "", int value = 0, Sprite image = null, bool disabled = false, SelectCell onSelect = null)
        {
            _caption = caption;
			_value = value;
            _image = image;
